...
export class JsSergiService{  
    ...
    login(psswd,user){        
        return this.http.get('http://172.17.0.98/projectes/escola/src/app/escola/JS/JsSergi/JsSergi.js?psswd='+psswd+"&user="+user).map(res => res.json());
