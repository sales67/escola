...
@Component({
  ...
  providers: [putCentreService]
    ...
    constructor(private updateMarcaService: putCentreService) { }
                            
        putCentre(){              this.updateMarcaService.putCentre(this.addId,this.addName,this.addTel,this.addCountry,this.addMail)
                  .catch((error: any) => {               
